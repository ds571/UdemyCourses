...
const VerifyEmail: React.FC<RouteComponentProps> = ({location}) => {
    ...
    const handleConfirmEmailResend = () => {
        agent.User.resendVerifyEmailConfirm(email as string).then(() =>{
            toast.success('Verificaiton email resent - please check your email');
            ...
            case Status.Failed:
                return (
                    <div className='center'>
                        <p>Verification failed - you can trying resending the verification email</p>
            ...
            case Status.Success:
                return (
                    <div className='center'>
                        ...
                        <Button
                            primary onClick={() => openModal(<LoginForm />)}
                            size='large'
